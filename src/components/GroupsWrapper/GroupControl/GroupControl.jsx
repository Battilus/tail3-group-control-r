...
const GroupControl = (props) => {
    ...
    const styleActive = 'border-black text-black shadow-md transition duration-300'
    ...
    return (
        <div className='font-sans relative'>
            ...
            >
                <input
                    className='border-0 w-4/5 m-0 outline-none py-1 pl-0.5 pr-3 placeholder-gray-300 focus:text-black'
                    type="text"
                ...
                <div className='flex items-center'>
                    {selected ?
                        <div
                            className='svg-btn hover:text-red-600 active:text-black'
                        ...
                        >
                            ...
                            <div
                                className='svg-btn hover:text-green-500 active:text-black'
                                onClick={() => {
